<%-- 
    ...
    Created on : Feb 26, 2022, 8:36:19 AM
    Author     : DN68
--%>
...
<html>
    ...
    <!-- Title  -->
    <title>Amado | Product Details</title>
    ...
    <div class="main-content-wrapper d-flex clearfix">
        ...
        <header class="header-area clearfix">
            ...
            <li><a href="view/cart.jsp">Cart<span> (${sessionScope.carts.size()})</span></a></li>
        ...
        <div class="single-product-area section-padding-100 clearfix">
            <div class="container-fluid">
                ...
                <div class="row" items="detail" var="o">
                            ...
                            <div id="product_details_slider" class="carousel slide" data-ride="carousel">
                                ...
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                        <a class="gallery_img" href="${detail.image}">
...
<!--                                <a href="view/product-details.jsp">-->
                                    <h6></h6>
                                </a>
                                <!-- Ratings & Review -->
                            ...
                            <!-- Add to Cart Form -->
                            <form class="cart clearfix" action="add-to-cart?pid=${detail.id}" method="post">
