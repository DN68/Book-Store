...
<html>
    ...
    <body>
        ...
        <div class="main-content-wrapper d-flex clearfix">
            ...
            <table class="col-12 col-lg-8" style="margin-top: 210px; min-height: 10px">
                <thead>
                    <tr>
                        <th scope="col">#</th>
                ...
                <tbody>
                    ...
                    <form action="update-quantity" >
                        ...
                        <td><a href="delete-cart?pid=${C.value.product.id}" style="font-size: large; color: red">Delete</a></td>
                        </tr>
                    </form>
                </c:forEach>
                </tbody>
            ...
            <div class="cart-btn mt-100">
                ...
                <a href="checkout" class="btn amado-btn w-100" style="margin-bottom: 20px">Checkout</a>
            </div>
            <!-- Header Area End -->
