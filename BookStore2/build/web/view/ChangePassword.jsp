...
<html>
    <head>
        ...
        <!-- Title  -->
        <title>Amado | Change Password</title>
                                ...
                                <form action="change" >
                                    <div class="row">
                                        <div class="col-12 mb-3">
                                            Old-Password: <input name="old-pass" type="password" class="form-control" id="password" placeholder="Password" value="${infor.password}" >
                                        </div>
                                        <div class="col-12 mb-3">
                                            New-Password: <input name="new-pass" type="password" class="form-control" id="password" placeholder="Password" value="${infor.password}" >
                                        </div>

                                        <div class="col-12 mb-3">
                                            Re-Newpassword: <input name="re-newpass" type="password" class="form-control" id="password" placeholder="Password" value="${infor.password}" >
                                        </div>
                                    </div>
