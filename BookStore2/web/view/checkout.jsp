...
<html>
    ...
    <body>
        ...
        <div class="main-content-wrapper d-flex clearfix">
            ...
            <div class="col-md-5"  > <table class="col-lg-12" style="margin-top: 210px; min-height: 1000px">
                    <h2>Check Out</h2>
                    <thead>
                        <tr>
                            <th scope="col">#</th>
            ...
            <div class="col-md-4" style="margin-top: 210px; min-height: 1000px" > 
                <form action="checkout" method="post" >
                   ...
                   <div class="mb-3">
                        ...
                        <input type="number" class="form-control" id="phone_number" name="phone" aria-describedby="emailHelp">
